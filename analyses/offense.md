...
This is already visible in the routine distribution. Of Barcelona’s offensive corners, 31 were direct inswingers, 11 were short corners, 4 were other direct deliveries, and only 1 was a direct outswinger [(oc1)](offense_plot.md#offensive_oc1). 
...
![](../assets/upload/offensive/corners/attempts_per_corner_bars.png)
<figcaption  style="margin-left: 5px">Attempts per Corner generated - Barcelona above average in short, below in crossed</figcaption>
...
A similar pattern appears in xG per corner: both routine types are slightly below average, but the gap is smaller for short corners. [(oc2)](offense_plot.md#offensive_oc2)
...
Raphinha clearly dominates as the corner taker, indicating a high level of delivery consistency [(oc3)](offense_plot.md#offensive_oc3).
By contrast, receivers and first shooters are more widely distributed across several players [(oc4)](offense_plot.md#offensive_oc4).
...
[from here on about spacial factors]: #
![](../assets/upload/offensive/corners/spatial_profile.png)
<figcaption  style="margin-left: 5px">Spatial Profile - two target zones visible</figcaption>

![](../assets/upload/offensive/corners/delivery_endpoints_by_side.png)
<figcaption  style="margin-left: 5px">Delivery endpoints by side- long corners predominantly from the right</figcaption>
The spatial maps deepen this reading, illustrating clear but not exclusive tendencies for areas of delivery. 
Many deliveries are directed into the central six-yard area and near-post corridor, with a smaller share toward the far post, the edge of the box, and wider recycle zones. 
...
<figcaption  style="margin-left: 5px">First touch map - sequence often continued with pass-on or carry</figcaption>
This is reinforced by the first-touch map. 
...
The goal-sequence maps illustrate this clearly. Both goals result from multi-action sequences rather than direct finishes from the original delivery. 
...
<figcaption  style="margin-left: 5px">Share of far post corners - only against NU and CPH</figcaption>
...
<figcaption  style="margin-left: 5px">Corner Map - Movements against Praha</figcaption>
...
<figcaption  style="margin-left: 5px">Corner Map - Movements against Newcastle</figcaption>
![](../assets/upload/offensive/corners/corner_2051683_04_right_1452_shot.png)
<figcaption  style="margin-left: 5px">Corner Map - Movements against Copenhagen</figcaption>
In the Copenhagen and the Newcastle example, the clearest pattern is a dense initial occupation of the six-yard box and near-post corridor, followed by short, curved, mainly vertical or diagonal runs into the goal area. 
...
<figcaption  style="margin-left: 5px">Corner Map - Movements against Frankfurt</figcaption>
The Frankfurt goal provides the clearest example of how Barcelona can add a stronger manipulation layer to this compact structure using their short-played alternative. 
...
#### 3c.a. Overview
- xG Direct vs Wide
- position heatmap direct vs wide

#### 3c.b. Wide Free Kicks
- Analysis similar to corner
- include offsides after ?

#### 3c.c. Direct Free Kicks
- shoot where 

#### 3c.d. Freekicks from own half
- far or short?
- include offsides after
