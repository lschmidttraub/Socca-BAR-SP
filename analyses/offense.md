...
|:--------------------------------------------------------------------:|:---------------------------------------------------------------:|
| ![](../assets/upload/offensive/corners/attempts_per_corner_bars.png) | ![](../assets/upload/offensive/appendix/xg_per_corner_bars.png) |
...
|:-----------------------------------------------------------------:|:----------------------------------------------------------------------:|
| ![](../assets/upload/offensive/appendix/corner_takers_single.png) | ![](../assets/upload/offensive/appendix/delivery_receivers_single.png) |
