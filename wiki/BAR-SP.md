...
| [Goal Kicks](BAR-SP/offese#goal-kicks)                                                | Investigates Barcelona's goal kick performance, through a pitch control model. |
...
| [Conclusion](BAR-SP/defense#conclusion)                                                 | Connects the defensive findings back to the hypotheses from previous analyses and derives recommendations. |
